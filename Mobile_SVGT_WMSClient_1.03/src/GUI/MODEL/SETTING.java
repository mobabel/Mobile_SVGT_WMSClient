...
public class SETTING {
    ...
    public static final double   realheight_dis_s0=32000;
    public static final double   realwidth_dis_s0=24000; 
	/** The real distance that will be displayed on the screen with scale option 1:300000*/
    public static final double   realheight_dis_s1=24000;
    public static final double   realwidth_dis_s1=18000;
	/** The real distance that will be displayed on the screen with scale option 1:200000*/
    public static final double   realheight_dis_s2=16000;
    public static final double   realwidth_dis_s2=12000;  
    	/** The real distance that will be displayed on the screen with scale option 1:120000*/
    public static final double   realheight_dis_s3=9600;
    public static final double   realwidth_dis_s3=9600; //7200 
	/** The real distance that will be displayed on the screen with scale option 1:2000*/
